    ...
    <div class="container-fluid">
        ...
        <div class="main-header-center">
            <div class="responsive-logo">
                <a href="{{route('home')}}"><img src="{{asset('/images/logo-wide.png')}}" class="mobile-logo" alt="logo"></a>
                <a href="{{route('home')}}"><img src="{{asset('/images/logo-wide-white.png')}}" class="mobile-logo-dark" alt="logo"></a>
            </div>
        </div>
        <div class="main-header-right">
            ...
            <div class="dropdown main-profile-menu">
                ...
                <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item border-top" href="{{ route('profiles.viewProfile') }}">
